...
(assert  (and (=  x1_P1 x4_P1 )  (and (=  x7_P1 x12_P1 )  (and (=  x15_P1 x22_P1 )  (and (=  x25_P1 x34_P1 )  (and (=  input4_P1_d8  "2001"  )  (and (=  input4_P1_d6  "1"  )  (and (=  x37_P1 x50_P1 )  (and (>  ( str.to_int input5_P1_d5  ) 10000 )  (and (isinteger  input5_P1_d5 )  (and (=  x1_P2 x4_P2 )  (and (=  x7_P2 x12_P2 )  (and (=  x15_P2 x22_P2 )  (and (=  x25_P2 x34_P2 )  (and (=  input4_P2_d8  "2001"  )  (and (=  input4_P2_d6  "1"  )  (and (=  x37_P2 x50_P2 )  (and (>  ( str.to_int input5_P2_d5  ) 10000 )  (and (isinteger  input5_P2_d5 )  (and (=  x55_P2 x55_P1 )  (and (=  ( select  x62 1 ) x58 )  (and (>=  1 0 )  (and (<  1 x59 )  (and (=  ( select  x62 0 ) x60 )  (and (>=  0 0 )  (and (<  0 x59 ) (>=  x59 0 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
(check-sat)
(get-model)
