...
(assert  (and (=  x1 x4 )  (and (=  x7 x12 )  (and (<=  ( str.to_int input1_d20  ) 500 )  (and (=  input3_d8  "CA"  )  (and  (not (=  ( str.substr input3_d9  0 (- 5 0) )  "86197"  ))  (and  (not (=  ( str.substr input3_d9  0 (- 5 0) )  "85669"  ))  (and (isinteger  input1_d20 )  (and (=  input4_d6  "1999"  )  (and (=  input4_d10  "1"  )  (not (=  x18 x27 )) ) ) ) ) ) ) ) ) ) )
(check-sat)
(get-model)
